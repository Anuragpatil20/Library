...
export default function LibraryManagement() {
  ...
  return (
    <div className="bg-[url('https://static.vecteezy.com/system/resources/previews/001/874/132/original/abstract-geometric-white-background-free-vector.jpg')] bg-cover">
    <div className="p-6 max-w-4xl mx-auto">
      <h1 className="text-3xl font-bold mb-4 uppercase text-center bg-clip-text text-transparent bg-gradient-to-r from-green-400 to-blue-500 font-semibold font-mono">Library Management</h1>
